...
export type BundleProduct = ProductInterface &
  ...
  CustomizableProductInterface & {
    ...
    Entretien?: Maybe<Scalars['String']>
    /**
    ...
    custom_tab_size?: Maybe<Scalars['String']>
    ...
    facebook_brand?: Maybe<Scalars['String']>
    ...
    hover_image?: Maybe<Scalars['String']>
    /**
...
export type CategoryInterface = {
  ...
  is_virtual_category?: Maybe<Scalars['Int']>
  ...
  url_suffix?: Maybe<Scalars['String']>
  use_name_in_product_search?: Maybe<Scalars['Int']>
  use_store_positions?: Maybe<Scalars['Int']>
  virtual_category_root?: Maybe<Scalars['Int']>
  virtual_rule?: Maybe<Scalars['String']>
}
...
export type SnowdogMenu = {
  ...
  /** Menu CSS class */
  css_class?: Maybe<Scalars['String']>
  /** Menu identifier */
  identifier?: Maybe<Scalars['String']>
  /** Menu ID */
...
/** SnowdogMenuNode defines all menu node information */
export type SnowdogMenuNode = {
  ...
  /** Node position */
  position?: Maybe<Scalars['Int']>
  /** Node target (0 for '_self', 1 for '_blank') */
...
export type SnowdogMenuNodes = {
  ...
  items?: Maybe<Array<Maybe<SnowdogMenuNode>>>
}
...
export type SnowdogMenus = {
  ...
  /** An array of menus */
  items?: Maybe<Array<Maybe<SnowdogMenu>>>
}
